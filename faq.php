<link href="https://fonts.googleapis.com/css?family=Pinyon+Script" rel="stylesheet"> <!-- esto deberia ir en el head -->
...
<div class="container-fluid">
	...
	<!--/panel-group-->
				...
				<div class="panel panel-default ">
					<div class="panel-heading accordion-toggle collapsed question-toggle" data-toggle="collapse" data-parent="#faqAccordion" data-target="#question2">
						<h4 class="panel-title">
							<a href="#" class="ing regtitulo">P: Se puede pagar con tarjeta de cr&eacute;dito?</a>
						</h4>
					...
					<div id="question2" class="panel-collapse collapse" style="height: 0px;">
						<div class="panel-body">
							...
							<p>No tenemos habilitados los pagos con tajetas de cr&eacute;dito momentaneamente</p>
						</div>
					</div>
				</div>
				<div class="panel panel-default ">
					<div class="panel-heading accordion-toggle collapsed question-toggle" data-toggle="collapse" data-parent="#faqAccordion" data-target="#question3">
						<h4 class="panel-title">
							<a href="#" class="ing regtitulo">P: Tienen un showroom?</a>
						</h4>
					...
					<div id="question3" class="panel-collapse collapse" style="height: 0px;">
						<div class="panel-body">
							...
							<p>El showroom esta situado en Monroe 840, capital federal </p>
						</div>
					</div>
				</div>
